...
/** An invite link (…/?join=ABCDE) lands straight on the join screen. */
const JOIN_CODE =
...
export default function App() {
  const [screen, setScreen] = useState<'setup' | 'online'>(JOIN_CODE ? 'online' : 'setup')
  ...
  if (screen === 'online') {
    return <OnlineFlow initialCode={JOIN_CODE} onExit={() => setScreen('setup')} />
  }
